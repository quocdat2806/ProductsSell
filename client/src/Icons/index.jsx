...
export const StoryIcon = ({ className }) => (
...
export const AllIcon = ({ className }) => (
  <svg
    aria-hidden="true"
    focusable="false"
    data-prefix="fas"
...
export const StudentsCountIcon = ({ className }) => {
  return (
    <svg
      aria-hidden="true"
      focusable="false"
...
export const TotalLessonIcon = ({ className }) => {
  return (
    <svg
      aria-hidden="true"
      focusable="false"
...
export const SloganIcon = ({ className }) => {
  return (
    <svg
      aria-hidden="true"
      focusable="false"
